...
export function mergeDetail(item: OutputItem, detail: ParsedDetail, phoneMode: PhoneExtractionMode = 'strict'): OutputItem {
  ...
  return {
    ...
    contactEmail,
    contactPhone,
    contactName: detail.poster?.name ?? item.contactName,
    recruiterName: detail.poster?.name ?? item.recruiterName,
    recruiterTitle: detail.poster?.title ?? item.recruiterTitle,
    recruiterUrl: detail.poster?.url ?? item.recruiterUrl,
    recruiterPhoto: detail.poster?.photo ?? item.recruiterPhoto,
